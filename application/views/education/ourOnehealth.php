...
<div class="row m-0 p-0">
    <div class="col-12 py-5 bg-primary text-center">
        <h1 class="p-0 m-0 text-white text-center ">One Health</h1>
    </div>
    <div class="col-12 p-sm-5 p-2">
        <div class="row m-0 p-0">
            <div class="col-12 col-sm-12 my-1">
                <a href="<?= site_url('education/ourProgram') ?>" class="btn btn-secondary"><i class="fas fa-bookmark"></i> Climate Change</a>
            </div>
            <div class="col-12 col-sm-12 my-1">
                <a href="<?= site_url('education/ourProgram') ?>" class="btn btn-secondary"><i class="fas fa-bookmark"></i> Digital Health </a>
            </div>
            <div class="col-12 col-sm-4">
                <div class="position-sticky  mb-5">
                    <div class="text-black rounded">
                        <div class="bg-white  py-3 text-white ">
                            <img class="h-100 w-100" src="https://images.unsplash.com/photo-1505576399279-565b52d4ac71?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1yZWxhdGVkfDF8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60" alt="">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-8 tab-content" id="v-pills-tabContent">
